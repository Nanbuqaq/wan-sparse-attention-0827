...
def main():
    ...
    if args.completed_frames<1 or not torch.cuda.is_available():
    ...
    generator=SAM2AutomaticMaskGenerator(model,points_per_side=8,points_per_batch=32,
    ...
    result={'status':'pass' if masks else 'negative','scope':'offline_completed_prefix_initialization_cost_probe',
        ...
        'peak_allocated_bytes':torch.cuda.max_memory_allocated(),'points_per_side':8,'points_per_batch':32,
