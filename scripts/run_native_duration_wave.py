...
def build_wave2_cases(spec,stage,assets,source,output,seed,valid_scenarios=None,expected_noise=None):
    ...
    if stage in ('matched_controls','timing_repeats','shared_route_repeats','shared_route125_repeats','shared_route125_reuse_repeats','shared_route0625_reuse_repeats','shared_route_holdout','recall_toy','recall_bead','recall_replication','scene_release','recent_control','recent_hopper_control','long_sum_regression','long_quality_replication'):
