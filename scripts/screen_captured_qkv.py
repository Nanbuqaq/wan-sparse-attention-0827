...
def candidates() -> list[dict]:
    ...
    add("adacluster", "q64_k64_t05", {"q_clusters": 64, "initial_k_clusters": 64, "max_added_clusters": 64, "distance_threshold": 0.5}, q=64, k=128, init=3)
    add("adacluster", "q100_k100_t10", {"q_clusters": 100, "initial_k_clusters": 100, "max_added_clusters": 64, "distance_threshold": 1.0}, q=100, k=164, init=5)
    add("adacluster", "q100_k100_t55", {"q_clusters": 100, "initial_k_clusters": 100, "max_added_clusters": 64, "distance_threshold": 5.5}, q=100, k=164, init=5)
